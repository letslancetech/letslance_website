...
import ecommerceBanner from "../../../../assets/EcommerceImgs/ecommerceBanner.png";
      ...
      <div className="flex flex-col items-center justify-center gap-10 md:flex-row md:gap-16 md:px-[8vw] 2xl:px-[20vw]">
        ...
        <div className="w-full text-center md:w-1/2 md:text-left">
          ...
          <p className="mt-4 text-base text-[#4f5665] md:text-lg">
            Boost online sales and deliver a seamless shopping experience with
            custom-built eCommerce platforms designed for scalability and ease
            of use. LetsLance develops intuitive storefronts, secure payment
            integrations, and powerful backend systems that simplify operations
