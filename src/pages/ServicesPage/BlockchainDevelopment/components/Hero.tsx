...
import banner from "../../../../assets/blockchain/banner.png";
      ...
      <div className="flex flex-col items-center justify-center gap-10 md:flex-row md:gap-16 md:px-[8vw] 2xl:px-[20vw]">
        ...
        <div className="w-full text-center md:w-1/2 md:text-left">
          ...
          <p className="mt-4 text-base text-[#4f5665] md:text-lg">
            Accelerate your digital transformation with custom blockchain
            solutions that drive transparency, boost security, eliminate
            middlemen, and power scalable decentralized applications across
            industries.
          </p>
