...
import webBanner from "../../../../assets/WebAppImgs/webBanner.png";
      ...
      <div className="flex flex-col items-center justify-center gap-10 md:flex-row md:gap-16 md:px-[8vw] 2xl:px-[20vw]">
        ...
        <div className="w-full text-center md:w-1/2 md:text-left">
          ...
          <p className="mt-4 text-base text-[#4f5665] md:text-lg">
            Design, develop and deploy web applications to bring impactful
            changes within your web development projects. LetsLance's
            development approach assists clients right from analyzing disruptive
            web development challenges to create an intuitive UI/UX, fully
            functional, and powerful web based solution.
          </p>
          <a href="/contact">
