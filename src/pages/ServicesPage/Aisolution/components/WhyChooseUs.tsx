...
const WhyChooseUs = () => {
  ...
  return (
    <section className="bg-slate-50 py-16 lg:py-24">
      <div className=" container m-auto mx-auto px-4 lg:px-8">
        {/* Section header */}
        ...
        {/* Features grid */}
        <div className="grid grid-cols-1 place-items-center justify-items-center gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-6 2xl:grid-cols-4">
