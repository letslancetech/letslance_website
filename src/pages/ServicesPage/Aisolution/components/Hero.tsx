...
import aiSolution from "../../../../assets/lanceImages/aiSolutions.png";
      ...
      <div className="flex flex-col items-center justify-center gap-10 md:flex-row md:gap-16 md:px-[8vw] 2xl:px-[20vw]">
        ...
        <div className="w-full text-center md:w-1/2 md:text-left">
          ...
          <p className="mt-4 text-base text-[#4f5665] md:text-lg">
            At LetsLance, we don’t just deliver AI solutions — we architect
            intelligence that thinks, adapts, and evolves with your business.
            Whether it’s automating time-draining processes or unlocking the
            hidden value in your data, we turn your toughest challenges into
            game-changing breakthroughs through custom-built AI.
          </p>
          <a href="/contact">
