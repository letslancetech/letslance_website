...
import testingBanner from "../../../../assets/testingImgs/testingBanner.png";
      ...
      <div className="flex flex-col items-center justify-center gap-10 md:flex-row md:gap-16 md:px-[8vw] 2xl:px-[20vw]">
        ...
        <div className="w-full text-center md:w-1/2 md:text-left">
          ...
          <p className="mt-4 text-base text-[#4f5665] md:text-lg">
            Ensure flawless performance and impeccable user experience with
            comprehensive quality assurance services. At LetsLance, we employ a
            blend of manual and automated testing to identify and eliminate
            defects early, ensuring your applications run smoothly, securely,
